...
const Welcome = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  return (
    ...
    >
      <motion.div
        className="w-3/5 md:w-1/2 flex flex-col justify-center items-center gap-10 bg-black/50 backdrop-blur-3xl md:backdrop-blur p-5 text-center rounded-3xl text-white"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
